...
public class ThrowablesTest extends TestCase {
    ...
    public void testGetRootCause_NoCause() {
        ...
        assertThat(Throwables.getRootCause(exception)).isSameAs(exception);
    }

    public void testGetRootCause_SingleWrapped() {
        SomeCheckedException cause = new SomeCheckedException();
        SomeChainingException exception = new SomeChainingException(cause);
        assertThat(Throwables.getRootCause(exception)).isSameAs(cause);
    }
    ...
    public void testGetCausalChain() {
        ...
        assertThat(Throwables.getCausalChain(ex)).isEqualTo(asList(ex, re, iae, sue));
        assertThat(Iterables.getOnlyElement(Throwables.getCausalChain(sue))).isSameAs(sue);
    ...
    public void testLazyStackTraceWorksInProd() {
        ...
        assertThat(lazyStackTraceIsLazy()).isTrue();
    }
}
