...
public class Utf8Test extends TestCase {
    ...
    public void testEncodedLength_validStrings() {
        assertThat(Utf8.encodedLength("")).isEqualTo(0);
        assertThat(Utf8.encodedLength("Hello world")).isEqualTo(11);
        assertThat(Utf8.encodedLength("Résumé")).isEqualTo(8);
        assertEquals(
                461,
                Utf8.encodedLength(
                        "威廉·莎士比亞（William Shakespeare，"
                                ...
                                + "哈都拕人翻譯做好多話。"));
        // A surrogate pair
        assertThat(Utf8.encodedLength(newString(MIN_HIGH_SURROGATE, MIN_LOW_SURROGATE))).isEqualTo(4);
    }
        ...
        for (int trial = 0; trial < 100; trial++) {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                if (utf8Length != Utf8.encodedLength(sb)) {
                    ...
                    assertThat(Utf8.encodedLength(sb)).isEqualTo(utf8Length);
                }
            }
        }
    }
    ...
    public void testShardsHaveExpectedRoundTrippables() {
        ...
        assertThat(actual).isEqualTo(EXPECTED_FOUR_BYTE_ROUNDTRIPPABLE_COUNT);
    }
    ...
    private static void assertWellFormed(int... bytes) {
        assertThat(Utf8.isWellFormed(toByteArray(bytes))).isTrue();
    }

    private static void assertNotWellFormed(int... bytes) {
        assertThat(Utf8.isWellFormed(toByteArray(bytes))).isFalse();
    }
    ...
    private static void testBytes(int numBytes, long expectedCount, long start, long lim) {
        ...
        for (long byteChar = start; byteChar < lim; byteChar++) {
            ...
            assertThat(Utf8.isWellFormed(bytes, 0, numBytes)).isEqualTo(isRoundTrippable);
